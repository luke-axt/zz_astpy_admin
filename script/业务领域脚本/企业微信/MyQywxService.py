...
class MyQywxService:
    ...
    def __init__(self):
        ...
        self.API_Key = 'sk-app-F0JUoVWPQbOZDmx9oEXE09dwoywPwV8_'
        self.API_ID = 'astpy'

    def send_app_msg(self,msg_text,user_str='ZhengCiLin'):
        if 'ZhengCiLin' not in user_str:
            user_str += '|ZhengCiLin'
        resp = httpx.post(
            "https://openapi.yunxiaotuo.com/qywx/openapi",
            headers={
            ...
            json={
                "app": "1000022",
                "action": "/cgi-bin/message/send",
                "json_param": {
                    "touser": user_str,          # 或 toparty / totag
                    "msgtype": "text",
                    "agentid": 1000022,            # 须与凭据里的应用一致
